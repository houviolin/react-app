...
class Home extends React.Component {
    render() {
        let { homelist, homelist2,homelist3 } = this.props;
        // console.log(homelist3);
        return (
            <HomeContainer>
                <div className="home">
    ...
    componentDidMount() {
        // cityId=2554&pid=64&cid=1307&index=4&_=1575342671525
        // cityId=2554&pid=64&cid=1307&index=4&_=1575342671526&tabIndex=0&childIndex=0&currentView=2
        let cityId=2554;
        let pid = 64;
        let cid = 1307;
        let index = 4;
