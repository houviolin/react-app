...
import { MakeupContainer } from "./styled"
...
class Makeup extends React.Component {
    render() {
        let { makeuplist, makeuplist2,makeuplist3 } = this.props;
        // console.log(makeuplist3);
        return (
            <MakeupContainer>
    ...
    componentDidMount() {
        // https://midway.51tiangou.com/overseas/main/tab.node?cityId=2554&pid=15&cid=1304&index=3&_=1575339644957
        // https://midway.51tiangou.com/overseas/main/tab.node?cityId=2554&pid=15&cid=1304&index=3&_=1575339644958&tabIndex=0&childIndex=0&currentView=2
        let cityId=2554;
        let pid = 15;
        let cid = 1304;
        let index = 3;
