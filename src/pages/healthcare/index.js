...
class Healthcare extends React.Component {
    render() {
        let { healthcarelist, healthcarelist2,healthcarelist3 } = this.props;
        // console.log(healthcarelist3);
        return (
            <HealthContainer>
    ...
    componentDidMount() {
        // cityId=2554&pid=16&cid=1303&index=5&_=1575343383460
        // cityId=2554&pid=16&cid=1303&index=5&_=1575343383461&tabIndex=0&childIndex=0&currentView=2
        let cityId=2554;
        let pid = 16;
        let cid = 1303;
        let index = 5;
